...
image: /assets/images/posts/2024-04-29-handling-ei-expose-rep/hero.png
date: 2024-04-29 10:00:00 +0800
categories: [java, security]
tags: [java, spotbugs, security, best-practices]
...
[SpotBugs](https://spotbugs.github.io/) is a great tool for static code analysis. Recently I got two similar warnings in one of the codebases I work on and I had to fix it.
...
**Option 1:** Return an unmodifiable list from the `getMyList()` method. You can change the getMyList() method as follows.
...
**Option 2:** Return a copy of the list from the `getMyList()` method. You can change the getMyList() method as follows.
...
**Option 1:** Creating a copy of the list when assigning it to the `myList` variable.
...
**Option 2:** Creating an unmodifiable list when assigning it to the `myList` variable.
