...
image: /assets/images/posts/2021-12-06-go-embed-instead-of-packr/hero.webp
date: 2021-12-06 10:00:00 +0800
categories: [golang, web-development]
tags: [golang, embed, static-files, packr]
...
e.g: if the file is `project-root/static/index.html` you will be able to access the file on `http://localhost:8080/static/index.html` 
